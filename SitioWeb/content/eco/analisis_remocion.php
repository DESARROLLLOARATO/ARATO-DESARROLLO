...
$consulta = "SELECT DISTINCT Modulo FROM datos_arato1 WHERE Tejido = '".$_GET['aplicacion']."'";
$res = mysqli_query($con,$consulta);

$consulta2 = "SELECT DISTINCT Patron FROM datos_arato1 WHERE Tejido = '".$_GET['aplicacion']."'";
$res2 = mysqli_query($con,$consulta2);

$consulta4 = "SELECT DISTINCT Lote FROM datos_arato1 WHERE Tejido = '".$_GET['aplicacion']."'";
$res4 = mysqli_query($con,$consulta4);

$consulta5 = "SELECT DISTINCT Cultivar FROM datos_arato1 WHERE Tejido = '".$_GET['aplicacion']."'";
$res5 = mysqli_query($con,$consulta5);

$consulta10 = "SELECT DISTINCT Campana FROM datos_arato1 WHERE Tejido = '".$_GET['aplicacion']."'";
                                      ...
                                      <tbody>
                                            <tr>
                                              <td width="80" align="right">
                                                ...
                                                <?php if(isset($_GET["aplicacion"]) and $_GET["aplicacion"] == "Pulpa" || $_GET["aplicacion"] == "Foliar"){ ?>                                                
                                                    <p>
                                                      Etapa:
                                                    </p>
                                                <?php } ?>
                                              ...
                                              <td width="80" align="left">
                                                <p>
                                                  <select onchange="location.href='analisis_remocion.php?aplicacion='+this.value+'#informe'" name="aplicacion" id="aplicacion">
                                                ...
                                                <?php if(isset($_GET["aplicacion"]) and $_GET["aplicacion"] == "1" and $_GET["aplicacion"] == "0" and $_GET["aplicacion"] == "Foliar" and $_GET["aplicacion"] == "Pulpa"){ ?>
                                                    <p>
                                                      <select name="aplicacion2" id="aplication2">
                                                        <option value="0" selected>Seleccione una aplicacion</option>
                                                      </select>
                                                    </p>
                                                <?php } ?>
                                                <!--  SELECT OPCIONALES   -->
